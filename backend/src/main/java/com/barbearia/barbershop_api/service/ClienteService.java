...
public class ClienteService {
    ...
    public DadosEntradaCadastroCliente cadastroUsuario(ClienteDTO dto) {
        ...
        cliente.setContato(dto.getContato().trim());
